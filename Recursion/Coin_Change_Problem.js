...
The second line contains  space-separated integers describing the respective values of each coin type : c  = [c[0], c[1], ..., c[m-1]]  (the list of distinct coins available in infinite amounts).
